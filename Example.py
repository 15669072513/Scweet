...
from Scweet.user import get_user_information, get_users_following, get_users_followers, get_two_level_follower_following
...
# #
# users = ['@daprdev', '@yassineaitjeddi', 'TahaAlamIdrissi',
...
# following = get_two_level_follower_following(users=users, env=env_path, headless=True, wait=2)
